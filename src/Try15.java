...
/** Change: Rounds as records containing **references to other rounds** */
record RoundB(RoundB leftContest, RoundB rightContest,
              String winner) {}
...
public class Try15 {
    ...
    public static int roundsWon(String flavor,
                                RoundB contest) {
        if (contest == null)
            return 0;
